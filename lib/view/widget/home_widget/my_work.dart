...
class MyWorkWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final globlalController = Get.find<GlobalController>();
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 18, vertical: 60),
      child: CustomAnimated(
        animationController: globlalController.animationController,
        animation: globlalController.animation,
        globalKey: GlobalKey(),
        child: SlideTransition(
          position: globlalController.animation,
          child: Column(
                          ...
                          GetBuilder<GlobalController>(builder: (controller) {
                            return Padding(
                              ...
                              child: MouseRegion(
                                ...
                                onExit: (_) =>
                                    controller.nexonButtonState(false),
                          ...
                          GetBuilder<GlobalController>(builder: (controller) {
                            return Padding(
                              ...
                              child: MouseRegion(
                                cursor: SystemMouseCursors.click,
                                onEnter: (_) =>
                                    controller.musicButtonState(true),
                                onExit: (_) =>
                                    controller.musicButtonState(false),
                                child: GestureDetector(
                                  onTap: () {
                                    Get.to(
                                      () => ProjectView(
                        ...
                        children: [
                          ...
                          GetBuilder<GlobalController>(builder: (controller) {
                            return Padding(
                              ...
                              child: MouseRegion(
                                onEnter: (_) =>
                                    controller.walletButtonState(true),
                                onExit: (_) =>
                                    controller.walletButtonState(false),
                                cursor: SystemMouseCursors.click,
                                child: GestureDetector(
                                  onTap: () => Get.to(
